...
data = {
    "calculate_travel_time": {
        "params": float(values['-DISTANCE-'])
        "return": "Travel time: {time_in_hours:.2f} hours or {time_in_minutes:.2f} minutes"
    },
    "fuel_consumption_total": {
        "params": ["distance", "fuel_consumption"],
        "return": "Fuel consumption: {fuel_consumption_total:.2f} L"
    },
    "calculate_total_cost": {
        "params": ["distance", "fuel_consumption", "fuel_price", "food_checked", "toll_checked", "euro_checked", "pound_checked"],
        "return": "Total cost: {total_cost:.2f} {currency}"
    }
}
